...
- **Bauteil-Foto** (das bestaetigte Foto aus der Preview)
...
- **Given** der Mechaniker hat ein Bauteil-Foto aufgenommen und bestaetigt
...
Keine direkte DB-Interaktion auf diesem Screen. Der Schritt ist bereits in der DB angelegt (Kamera-View) und das Bauteil-Foto ist bereits persistiert (Preview-View). Dieser Screen liest nur den bestehenden Zustand.
